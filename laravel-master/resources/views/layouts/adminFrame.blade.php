<?php
$menus = [];
$manageHome = ['id'=>"menu-ManageHome", 'label'=>'首页内容管理', 'items'=>array(
    ['dataHref' => url('admin/ManageHome'), 'label' => '首页内容管理','dataTitle' => '首页内容管理1'],
    ['dataHref' => url('admin/ManageHome1'), 'label' => '首页内容管理','dataTitle' => '首页内容管理2'],
    ['dataHref' => url('admin/ManageHome2'), 'label' => '首页内容管理','dataTitle' => '首页内容管理3'],
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="{{$list['id']}}">
            <dt><i class="Hui-iconfont">&#xe616;</i> {{$list['label']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="{{SKIN_ADMIN}}h-ui/v1/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
