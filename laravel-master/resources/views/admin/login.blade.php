...
<head>
    ...
    <link href="/skin/admin/css/font-awesome.min.css" rel='stylesheet' type='text/css'>


    <!-- Styles -->
    <link href="/skin/admin/css/bootstrap.min.css" rel="stylesheet">
    <link href="/skin/admin/css/c.css" rel="stylesheet">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-btn fa-sign-in"></i>登录系统
                                    </button>

                                    <a class="btn btn-link" href="{{ url('/password/reset') }}">不记得密码?</a>
                                </div>
                            </div>
                        </form>
                    </div>
