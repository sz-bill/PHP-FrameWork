            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{ url('admin/product/add') }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('sku') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="sku" value="<?php echo substr(uniqid(10), 8);?>">
                            ...
                            <div class="form-group{{ $errors->has('qty') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="qty" value="10000">
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="price" value="1.03">
                            ...
                            <div class="form-group{{ $errors->has('depth') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="depth" value="1">
                            ...
                            <div class="form-group{{ $errors->has('height') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="height" value="1">
                            ...
                            <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label">重量(包装)</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea style="min-height: 200px;" class="form-control description" name="description">产品描述</textarea>
