...
@section('content')
    ...
    <div class="page-container">
        <form action="" method="post" class="form form-horizontal" id="form-article-add">
            {!! csrf_field() !!}
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片位置：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <select class="select" name="page_code">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">是否多图：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <select class="select" name="is_more">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分组类型：</label>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="title" value="<?php echo '主标题-' . time();?>" placeholder="">

                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">图片副标题：</label>
                <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" name="sub_title" value="<?php echo '图片副标题-' . time();?>" placeholder="">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="page_url" value="{{ url('admin/product/add') . '/url/' . time() }}" placeholder="">
                </div>
            </div>
